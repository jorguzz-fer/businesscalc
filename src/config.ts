...
// NOTE: we do NOT call .strict() here. process.env always contains dozens of
// unrelated host/runtime vars (PATH, HOME, etc) — zod's default behavior is
// to ignore unknown keys, which is exactly what we want. `.strict()` would
// reject them and prevent the process from starting.
